    ...
    if (user) {
      ...
      message.reply({
        embeds: [new MessageEmbed()
          ...
          .setFooter(`${user.username} | Powered by Limsathyacord`, "https://cdn.discordapp.com/attachments/867334683566014474/900288030772965416/143378347-ls-logo-letter-monogram-with-triangle-shape-design-template-isolated-on-black-background.jpg")
        ],
