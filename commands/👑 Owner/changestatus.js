  ...
  run: async (client, message, args, cmduser, text, prefix, player, es, ls) => {
    ...
    async function first_layer() {
      ...
      let MenuEmbed = new MessageEmbed()
        .setColor(es.color)
        .setAuthor('Change Status', 'https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/au-kddi/190/purple-heart_1f49c.png', 'https://discord.gg/uYRDDx7yFn')
